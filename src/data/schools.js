export const schools = [
  ...
  },
  {
    ...
    teachingMethod: '秉持“学校，让生命更灵动”理念，开展跨学科RAINBOW实践体验课程，注重身心健康发展。',
    reputation: '连续多年获办学绩效一等奖，硬件设施极佳，校园活动丰富，社团成绩拔尖。',
    advantages: '紫竹园区标配起点，升学路径直通华二附初，生源质量受到园区高新人才家庭托底保障。',
    photos: [
