export const schools = [
  // --- 闵行区 紫竹及周边 ---
  {
    ...
    tags: ['钱学森班', '科技教育', '四大摇篮'],
    admissionRate: [{ year: '2023', rate: 75, label: '预录取+市重点率' }, { year: '2024', rate: 78, label: '市重点达线率' }],
  ...
  },
  {
    ...
    tags: ['国际视野', '全人教育', '个性化滴灌'],
    admissionRate: [{ year: '2023', rate: 70, label: '海内外名校升学率' }, { year: '2024', rate: 75, label: '百强大学录取率' }],
    teachingMethod: '“教的多样性”与“学的多样性”并举。实行横向差异化选课与纵向全息成长的双向培养。',
    reputation: '不仅能走体制内中考，亦能无缝衔接国际高中。家长尤其赞赏其不盲目内卷时长，肥胖和近视率逐年下降的高效管理。',
    advantages: '依托“三大发展中心”（课程、学生、教师），打通九年一贯制资源库；深度联动紫竹高新区（如英特尔AI、交大水下机器人）资源。',
    curriculumAnalysis: [
      {
        title: "三大中心协同底层基石",
        desc: "打破常规教研组，设立课程、学生、教师发展三大中心。将音体美老师编制统归学生发展中心统一调度，确保学术与素质教育资源的无缝整合。"
      },
      {
        title: "“圣华学子画像”与精准滴灌",
        desc: "依据国家大纲制定校内标准（已达/未达/超标）。提供精细化的“个性化滴灌”选课方案，满足学生培优补弱及双语强项的刚性需求。"
      },
      {
        title: "逾60%艺体比重的CCA体系",
        desc: "课外课覆盖五大板块，其中艺体与戏剧占60%。通过联动周边高新企业（如水下机器人、英特尔AI基地）和大学，让拔尖课内化，节省家庭外部精力。"
      },
      {
        title: "跨学科项目与多元教态",
        desc: "开设如“环游世界80天”等融合性高强度的跨学科探究模块。这不仅拓宽了国际视野，更是实打实降低了学生的近视率和肥胖率（每年下降1%）。"
      }
    ],
    photos: [
  ...
  },
  {
    ...
    curriculumAnalysis: [
      {
        title: "主核底盘盘稳固",
        desc: "语数外严格遵循上海市等第制与零起点政策，融入华师大「新基础教育」教案，通过游戏化和高频互动切断死记硬背的低效模式。"
      },
      {
        title: "大体育与艺术护城河",
        desc: "每天必有专门体育课及30分钟阳光大课间，内置全校普及的全国冠军级花样跳绳、啦啦操与武术，极致保护视力与体格发育。"
      },
      {
        title: "RAINBOW 特色双翼",
        desc: "每周常设探究型校本课程窗。依托高新区与交大/华师大资源，免费辐射提供编程、领导力、冰雪运动、管弦乐等极高溢价的素质前沿课。"
      },
      {
        title: "'双减'晚托过滤墙",
        desc: "3:30后提供阶梯式课后服务。前45分钟名师督导力求'作业不出校门'，后45分钟接入各色高校级兴趣社团，彻底解放家长晚间辅导压力。"
      }
    ],
    photos: [
  ...
  // --- 静安区 市北高新及辐射区 ---
  {
    ...
    admissionRate: [{ year: '2023', rate: 90, label: '理科班四大名校率' }, { year: '2024', rate: 70, label: '整体市重点达线率' }],
  ...
  },
  {
    ...
    tags: ['好学力行', '理科培优', '0班直通'],
    admissionRate: [{ year: '2023', rate: 31, label: '市重点率(静安平均之上)' }, { year: '2024', rate: 35, label: '市重点率(含名额分配)' }],
  ...
  },
  {
    ...
    admissionRate: [{ year: '2023', rate: 46, label: '690分以上极端高分率' }, { year: '2024', rate: 65, label: '市重点达标率' }],
  ...
  },
  {
    ...
    tags: ['优质均衡', '百门校本', '口碑佳'],
    admissionRate: [{ year: '2023', rate: 58, label: '市区重点达线率' }, { year: '2024', rate: 60, label: '市区重点合并录取率' }],
  ...
  // --- 浦东新区 张江高科 ---
  {
    ...
    tags: ['浦东霸主', '理科强校', '民转公'],
    admissionRate: [{ year: '2023', rate: 70, label: '市重点率(部分含四大)' }, { year: '2024', rate: 21.6, label: '中考700分以上占比' }],
